...
import static com.lun.hamcrest.IsPositiveInteger.isAPositiveInteger;
...
public class HamcrestMatcherUnitTest {
	...
	public void given2Classes_whenOneInheritsFromOther_thenCorrect() {
		...
		assertThat(Cat.class, typeCompatibleWith(Cat.class));
	}
	...
	//Number
	@Test
	public void givenAnInteger_whenEqualTo0_thenCorrect() {
		int num = 0;
